...
const SHAPE = {
  ...
  pentagon: { d:'M64 6 122 48 100 120H28L6 48z',              bg:'fyg',   fg:'black', gs:.62, pad:[22,26,106,110], edge:'black', edgeW:4 },
...
{id:'noRightTurn', name:'No right turn', cat:'reg', shape:'square', art:{g:'turnRight', ring:'no'},
 means:'Do not turn right at this intersection.', tip:'Red circle + slash = banned.'},
...
{id:'noTrucks', name:'No trucks', cat:'reg', shape:'square', art:{g:'truck', ring:'no'},
 means:'Trucks are not permitted on this road.', tip:'Often on residential shortcuts.'},
...
{id:'keepRight', name:'Keep right', cat:'reg', shape:'square', art:{g:'keepRight'},
 means:'Keep to the right of the traffic island or divider ahead.', tip:'The arrow shows the side you must pass on.'},
...
{id:'yieldAhead', name:'Yield sign ahead', cat:'warn', shape:'diamond', art:{g:'triangleDown', gs:.46},
 means:'A yield sign is coming up.', tip:'Prepare to give way.'},
...
{id:'tIntersection', name:'T-intersection ahead', cat:'warn', shape:'diamond', art:{g:'tIntersect', gs:.50},
 means:'The road you are on ends ahead — you must turn left or right.', tip:'Dead end for straight-ahead.'},
...
{id:'yIntersection', name:'Y-intersection ahead', cat:'warn', shape:'diamond', art:{g:'yIntersect', gs:.50},
 means:'The road splits ahead — choose your side.', tip:'Signal for the branch you want.'},
...
{id:'dipAhead', name:'Dip ahead', cat:'warn', shape:'diamond', art:{g:'dip', gs:.50},
 means:'A sudden dip in the road ahead.', tip:'Water collects in dips.'},
...
{id:'mooseArea', name:'Moose area', cat:'warn', shape:'diamond', art:{g:'moose', gs:.52},
 means:'Moose cross this road. They are tall, dark and hard to see.', tip:'Northern Ontario. Slow down at dusk.'},
...
{id:'exitSign', name:'Freeway exit', cat:'info', shape:'wide', art:{bg:'green', fg:'white', edge:'white', t:[{s:'EXIT 25',size:22}]},
 means:'Names the numbered exit ahead.', tip:'GREEN = where you are going.'},
...
{id:'fuelSign', name:'Fuel available', cat:'info', shape:'square', art:{bg:'blue', fg:'white', edge:'white', g:'fuel', gs:.55},
 means:'Fuel is available at this exit.', tip:'Blue = services.'},
{id:'foodSign', name:'Food available', cat:'info', shape:'square', art:{bg:'blue', fg:'white', edge:'white', g:'food', gs:.55},
 means:'Restaurants at this exit.', tip:'Blue = services.'},
{id:'campSign', name:'Campground', cat:'info', shape:'square', art:{bg:'brown', fg:'white', edge:'white', g:'camp', gs:.55},
 means:'A park or campground is nearby.', tip:'BROWN = parks, recreation and culture.'},
...
{id:'schoolPatrol', name:'School crossing guard stop sign', cat:'other', shape:'octagon', art:{t:[{s:'STOP',size:26}], gy:-2},
 means:'Held by a crossing guard. Stop until every person AND the guard are off the road.', tip:'Ignoring it: big fine plus 3 demerit points.'},
{id:'objectMarker', name:'Object marker', cat:'other', shape:'tall', art:{bg:'black', fg:'yellow', edge:null, g:'stripes', gfg:'yellow', gs:.78, t:[]},
 means:'Marks an obstruction beside or in the roadway.', tip:'Stripes point down toward the side you should pass on.'}
];
